...
typedef seos_err_t
(*SeosCryptoApi_Rng_getBytesT)(SeosCryptoApi_Context* self,
                               unsigned int           flags,
                               void*                  buf,
                               const size_t           bufSize);

typedef seos_err_t
(*SeosCryptoApi_Rng_reseedT)(SeosCryptoApi_Context* self,
                             const void*            seed,
...
typedef seos_err_t
(*SeosCryptoApi_Mac_initT)(SeosCryptoApi_Context*      self,
                           SeosCryptoApi_Mac*          pMacHandle,
                           const SeosCryptoApi_Mac_Alg algorithm);

typedef seos_err_t
(*SeosCryptoApi_Mac_freeT)(SeosCryptoApi_Context*  self,
                           const SeosCryptoApi_Mac macHandle);

typedef seos_err_t
(*SeosCryptoApi_Mac_startT)(SeosCryptoApi_Context*  self,
                            const SeosCryptoApi_Mac macHandle,
                            const void*             secret,
                            const size_t            secretLen);

typedef seos_err_t
(*SeosCryptoApi_Mac_processT)(SeosCryptoApi_Context*  self,
                              const SeosCryptoApi_Mac macHandle,
                              const void*             data,
                              const size_t            dataLen);

typedef seos_err_t
(*SeosCryptoApi_Mac_finalizeT)(SeosCryptoApi_Context*  self,
                               const SeosCryptoApi_Mac macHandle,
                               void*                   mac,
                               size_t*                 macSize);
...
typedef seos_err_t
(*SeosCryptoApi_Digest_initT)(SeosCryptoApi_Context*         self,
                              SeosCryptoApi_Digest*          pDigestHandle,
                              const SeosCryptoApi_Digest_Alg algorithm);

typedef seos_err_t
(*SeosCryptoApi_Digest_freeT)(SeosCryptoApi_Context*     self,
                              const SeosCryptoApi_Digest digestHandle);

typedef seos_err_t
(*SeosCryptoApi_Digest_cloneT)(SeosCryptoApi_Context*     self,
                               const SeosCryptoApi_Digest dstDigHandle,
                               const SeosCryptoApi_Digest srcDigHandle);

typedef seos_err_t
(*SeosCryptoApi_Digest_processT)(SeosCryptoApi_Context*     self,
                                 const SeosCryptoApi_Digest digestHandle,
                                 const void*                data,
                                 const size_t               dataLen);

typedef seos_err_t
(*SeosCryptoApi_Digest_finalizeT)(SeosCryptoApi_Context*     self,
                                  const SeosCryptoApi_Digest digestHandle,
                                  void*                      digest,
                                  size_t*                    digestSize);
...
typedef seos_err_t
(*SeosCryptoApi_Key_generateT)(SeosCryptoApi_Context*        self,
                               SeosCryptoApi_Key*            pKeyHandle,
                               const SeosCryptoApi_Key_Spec* spec);

typedef seos_err_t
(*SeosCryptoApi_Key_makePublicT)(SeosCryptoApi_Context*           self,
                                 SeosCryptoApi_Key*               pPubKeyHandle,
                                 const SeosCryptoApi_Key          prvKeyHandle,
                                 const SeosCryptoApi_Key_Attribs* attribs);

typedef seos_err_t
(*SeosCryptoApi_Key_importT)(SeosCryptoApi_Context*        self,
                             SeosCryptoApi_Key*            pKeyHandle,
                             const SeosCryptoApi_Key       wrapKeyHandle,
                             const SeosCryptoApi_Key_Data* keyData);

typedef seos_err_t
(*SeosCryptoApi_Key_exportT)(SeosCryptoApi_Context*  self,
                             const SeosCryptoApi_Key keyHandle,
                             const SeosCryptoApi_Key wrapKeyHandle,
                             SeosCryptoApi_Key_Data* keyData);

typedef seos_err_t
(*SeosCryptoApi_Key_getParamsT)(SeosCryptoApi_Context*  self,
                                const SeosCryptoApi_Key keyHandle,
                                void*                   keyParams,
                                size_t*                 paramSize);

typedef seos_err_t
(*SeosCryptoApi_Key_loadParamsT)(SeosCryptoApi_Context*        self,
                                 const SeosCryptoApi_Key_Param name,
                                 void*                         keyParams,
                                 size_t*                       paramSize);

typedef seos_err_t
(*SeosCryptoApi_Key_freeT)(SeosCryptoApi_Context*  self,
                           const SeosCryptoApi_Key keyHandle);

// ----------------------------- Signature API ---------------------------------

typedef seos_err_t
(*SeosCryptoApi_Signature_initT)(SeosCryptoApi_Context*
                                 self,
...
typedef seos_err_t
(*SeosCryptoApi_Signature_freeT)(SeosCryptoApi_Context*
                                 self,
                                 const SeosCryptoApi_Signature sigHandle);

typedef seos_err_t
(*SeosCryptoApi_Signature_signT)(SeosCryptoApi_Context*
                                 self,
                                 const SeosCryptoApi_Signature sigHandle,
                                 const void*                   hash,
...
typedef seos_err_t
(*SeosCryptoApi_Signature_verifyT)(SeosCryptoApi_Context*
                                   self,
                                   const SeosCryptoApi_Signature sigHandle,
                                   const void*                   hash,
                                   const size_t                  hashSize,
...
typedef seos_err_t
(*SeosCryptoApi_Agreement_initT)(SeosCryptoApi_Context*
                                 self,
...
typedef seos_err_t
(*SeosCryptoApi_Agreement_freeT)(SeosCryptoApi_Context*
                                 self,
                                 const SeosCryptoApi_Agreement agrHandle);

typedef seos_err_t
(*SeosCryptoApi_Agreement_agreeT)(SeosCryptoApi_Context*
                                  self,
                                  const SeosCryptoApi_Agreement agrHandle,
                                  const SeosCryptoApi_Key       pubHandle,
                                  void*                         shared,
...
typedef seos_err_t
(*SeosCryptoApi_Cipher_initT)(SeosCryptoApi_Context*         self,
...
typedef seos_err_t
(*SeosCryptoApi_Cipher_freeT)(SeosCryptoApi_Context*     self,
                              const SeosCryptoApi_Cipher cipherHandle);

typedef seos_err_t
(*SeosCryptoApi_Cipher_processT)(SeosCryptoApi_Context*     self,
                                 const SeosCryptoApi_Cipher cipherHandle,
                                 const void*                data,
                                 const size_t               dataLen,
                                 void*                      output,
...
typedef seos_err_t
(*SeosCryptoApi_Cipher_startT)(SeosCryptoApi_Context*     self,
                               const SeosCryptoApi_Cipher cipherHandle,
                               const void*                data,
                               const size_t               dataLen);

typedef seos_err_t
(*SeosCryptoApi_Cipher_finalizeT)(SeosCryptoApi_Context*     self,
                                  const SeosCryptoApi_Cipher cipherHandle,
                                  void*                      output,
                                  size_t*                    outputSize);
