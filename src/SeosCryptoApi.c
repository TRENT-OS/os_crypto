...
seos_err_t
SeosCryptoApi_Rng_getBytes(SeosCryptoApi_Context*       ctx,
...
seos_err_t
SeosCryptoApi_Rng_reseed(SeosCryptoApi_Context* ctx,
                         const void*            seed,
...
seos_err_t
SeosCryptoApi_Mac_init(SeosCryptoApi_Context*      ctx,
...
seos_err_t
SeosCryptoApi_Mac_free(SeosCryptoApi_Context*  ctx,
...
seos_err_t
SeosCryptoApi_Mac_start(SeosCryptoApi_Context*  ctx,
                        const SeosCryptoApi_Mac macHandle,
                        const void*             secret,
...
seos_err_t
SeosCryptoApi_Mac_process(SeosCryptoApi_Context*  ctx,
                          const SeosCryptoApi_Mac macHandle,
                          const void*             data,
...
seos_err_t
SeosCryptoApi_Mac_finalize(SeosCryptoApi_Context*  ctx,
                           const SeosCryptoApi_Mac macHandle,
                           void*                   mac,
                           size_t*                 macSize)
{
...
seos_err_t
SeosCryptoApi_Digest_init(SeosCryptoApi_Context*         ctx,
...
seos_err_t
SeosCryptoApi_Digest_free(SeosCryptoApi_Context*     ctx,
...
seos_err_t
SeosCryptoApi_Digest_clone(SeosCryptoApi_Context*     ctx,
...
seos_err_t
SeosCryptoApi_Digest_process(SeosCryptoApi_Context*     ctx,
                             const SeosCryptoApi_Digest digestHandle,
                             const void*                data,
...
seos_err_t
SeosCryptoApi_Digest_finalize(SeosCryptoApi_Context*     ctx,
                              const SeosCryptoApi_Digest digestHandle,
                              void*                      digest,
                              size_t*                    digestSize)
{
...
seos_err_t
SeosCryptoApi_Signature_init(SeosCryptoApi_Context*            ctx,
...
seos_err_t
SeosCryptoApi_Signature_free(SeosCryptoApi_Context*        ctx,
...
seos_err_t
SeosCryptoApi_Signature_sign(SeosCryptoApi_Context*        ctx,
                             const SeosCryptoApi_Signature sigHandle,
                             const void*                   hash,
...
seos_err_t
SeosCryptoApi_Signature_verify(SeosCryptoApi_Context*        ctx,
                               const SeosCryptoApi_Signature sigHandle,
                               const void*                   hash,
                               const size_t                  hashSize,
...
seos_err_t
SeosCryptoApi_Agreement_init(SeosCryptoApi_Context*            ctx,
...
seos_err_t
SeosCryptoApi_Agreement_free(SeosCryptoApi_Context*        ctx,
...
seos_err_t
SeosCryptoApi_Agreement_agree(SeosCryptoApi_Context*        ctx,
                              const SeosCryptoApi_Agreement agrHandle,
                              const SeosCryptoApi_Key       pubHandle,
                              void*                         shared,
                              size_t*                       sharedSize)
...
seos_err_t
SeosCryptoApi_Key_generate(SeosCryptoApi_Context*        ctx,
...
seos_err_t
SeosCryptoApi_Key_makePublic(SeosCryptoApi_Context*           ctx,
...
seos_err_t
SeosCryptoApi_Key_import(SeosCryptoApi_Context*        ctx,
                         SeosCryptoApi_Key*            pKeyHandle,
...
seos_err_t
SeosCryptoApi_Key_export(SeosCryptoApi_Context*  ctx,
...
seos_err_t
SeosCryptoApi_Key_getParams(SeosCryptoApi_Context*  ctx,
                            const SeosCryptoApi_Key keyHandle,
                            void*                   keyParams,
                            size_t*                 paramSize)
{
...
seos_err_t
SeosCryptoApi_Key_loadParams(SeosCryptoApi_Context*        ctx,
...
seos_err_t
SeosCryptoApi_Key_free(SeosCryptoApi_Context*  ctx,
                       const SeosCryptoApi_Key keyHandle)
{
    return (NULL == ctx) ? SEOS_ERROR_INVALID_PARAMETER :
...
seos_err_t
SeosCryptoApi_Cipher_init(SeosCryptoApi_Context*         ctx,
...
seos_err_t
SeosCryptoApi_Cipher_free(SeosCryptoApi_Context*     ctx,
...
seos_err_t
SeosCryptoApi_Cipher_process(SeosCryptoApi_Context*     ctx,
                             const SeosCryptoApi_Cipher cipherHandle,
                             const void*                data,
                             const size_t               dataSize,
                             void*                      output,
...
seos_err_t
SeosCryptoApi_Cipher_start(SeosCryptoApi_Context*     ctx,
                           const SeosCryptoApi_Cipher cipherHandle,
                           const void*                ad,
                           const size_t               adLen)
{
...
seos_err_t
SeosCryptoApi_Cipher_finalize(SeosCryptoApi_Context*     ctx,
                              const SeosCryptoApi_Cipher cipherHandle,
                              void*                      output,
                              size_t*                    outputSize)
{
